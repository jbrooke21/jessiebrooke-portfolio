...
export default function Footer() {
  return (
    <footer className="w-full pt-12 pb-6">
      <div className="mx-auto px-20 lg:px-22">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          
          {/* Email */}
          <motion.a
            href="mailto:jessbrooke21@gmail.com"
            className="font-['Poppins'] font-medium italic text-[24px] md:text-[28px] hover:text-[#70b110] transition-colors"
          ...
          <div className="flex items-center gap-2">
           ...
           <motion.a
                ...
                <div className="w-[110px] h-[110px] flex items-center justify-center">
                    <svg
                    className="w-[88px] h-[88px] translate-y-[2px]"
